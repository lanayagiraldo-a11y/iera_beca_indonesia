...
const STEPS = [
  ...
  { id: 'passport',   title: 'Pasaporte',             subtitle: 'Travel document details',                          icon: '🛂', estimate: '1 min' },
          ...
          {stepDef.id === 'islamic' && (
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {MUSLIM_STATUS_OPTIONS.map((opt) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-slate-500">{opt.ofscription}</div>
                    </label>
                  ))}
                </div>
              ...
              <div className="pt-5 border-t border-slate-200">
                ...
                <p className="text-xs text-slate-500 mb-3">Optional. Agrega los cursos que hayas tomado.</p>
          ...
          {stepDef.id === 'motivation' && (
            <div className="space-y-6">
              ...
              <FullField label="What dawah activities are you currently involved in?" hint="Optional, but it helps us understand your commitment">
                <textarea className="input-base min-h-[100px]" value={form.dawah_activities_current} onChange={(e) => update('dawah_activities_current', e.target.value)} placeholder="Ejemplos: circulo semanal de Coran, voluntariado en mezquita, redes sociales, clases..." />
              </FullField>
